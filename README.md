...
# [Deploy Project Generated by ReduxSimpleStarter](https://www.udemy.com/react-redux/learn/v4/t/lecture/5691864?start=0)
## [ReduxSimpleStarter](https://github.com/ywCN/ReduxSimpleStarter)
- add a `server.js` file in root dir with following content
```
...
```
- change the "scripts" section in package.json according to following
```
  "scripts": {
