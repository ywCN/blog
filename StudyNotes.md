...
9. Note: mini-youtube, weather-site, book-info, blog are generated by ReduxSimpleStarter
...
- Redux Form saves our time on wiring form components with Redux.
  - Technically, we can wire them manually, but it is a complicated process.
- Note: Redux Form is **ONLY** responsible for handle state and validation of forms.
